...
class SPRCategoricalDQN(CategoricalDQN):
    ...
    def process_returns(self, samples):
        ...
        advantage = return_ - value # assume always not using gae
        # else:
    ...
    # def actor_critic_rl_loss(self, log_pred_ps, samples, index):
    #     actor_loss = samples.all_reward[index+self.n_step_return]
    #     critic_loss = 
