...
sys.path.append('/home/v-changminyu/Desktop/ChangminYu/reinforcement_learning/spr')
...
from src.rlpyt_atari_env import AtariEnv, DeepMindControlEnv, dmControlTrajInfo
from src.utils import set_config

# from src.wrappers import DeepMindControl
print('imported useful things')
os.environ['MUJOCO_GL'] = 'osmesa'
print('set mujoco_gl environment for rendering')

def build_and_train(game="pong", run_ID=0, cuda_idx=0, args=None):
    np.random.seed(args.seed)
    torch.manual_seed(args.seed)
    env = DeepMindControlEnv
